		...
		int nrhs, const mxArray *prhs[] )
{
	...
	if(nrhs > 1 && nrhs < 5)
	{
		...
		{
			const char *error_msg;
// 			mexPrintf("l, n, bias: %d, %d, %f\n", prob.l, param.solver_type, prob.bias);
// 			mexPrintf("eps, C, p: %f, %f, %f\n", param.eps, param.C, param.p);

// 			mexPrintf("Weight : ");
			
// 			for (weiIdx = 0; weiIdx < 2; ++weiIdx)
// 			{
// 				mexPrintf("( %d, %f ) | ", param.weight_label[weiIdx], param.weight[weiIdx]);
// 			}
// 			mexPrintf("\n");
